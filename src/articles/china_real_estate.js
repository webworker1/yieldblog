...
class ChinaRealEstate extends React.Component {
    ...
    render() {
        return (<div className="article-wrapper">
                    ...
                    Enjoy the numbers below, which represents a careful, "typical person" situation in various major cities:
                    ...
                    3. In part due to zero property taxes, Beijing and Shanghai rental yields are incredibly low: ~1% yields versus 2.7% for Manhattan to up to 4.7% for Dallas (note all figures are net of local property taxes and estimated repair costs).  This is hugely concerning:  Chinese government 10-year bonds yield 3.2% so the fact that investors are willing to accept 1% rental returns suggests that <u>poor investment alternatives are not the only cause:</u> investors are not just yield-starved for new investment opportunities, but in fact continue to speculate aggressively.<br /> 
                    4. Dallas residents have the highest net take-home pay after rent of all US cities surveyed, at $35k, and Brooklyn has one of the lowest in the US at $15k. <br/> <br/>
                    ...
                    <b>Above, Mr. Wang trying to save for a home</b><br/><br/>
                    The South China Morning Post has written an article discussing how there definitely seem to be <Link href="https://www.scmp.com/news/china/policies-politics/article/2086636/why-rate-home-ownership-so-high-among-chinese">cultural preferences</Link>:
                    <QuoteStub quotedText="“Properties are fixed assets, a more material investment than something like stocks,” Ye said.
                    ...
                    <br/>This preference seems to even extend to Chinese-American households: in a <Link href="https://lusk.usc.edu/research/working-papers/why-are-chinese-homeownership-rates-so-high"> 2003 whitepaper entitled "Why are Chinese Homeownership Rates so high?" </Link>
                    ...
                    <br/>One commonly recited story, recently told to me by a friend who'd been to China recently, went something like this: <br/> <br/>
                    ...
                    In actual China, families are massively overweighted toward housing with 74% of total assets in real estate compared to the US at only 35%: <Image widthOverride="450px" href="https://cdn1.i-scmp.com/sites/default/files/images/methode/2018/11/26/266b2d7e-f07e-11e8-b0fe-c62dccd2d711_972x_181123.jpg" />
                    ...
                    <br/><br/>From everything here, we can answer Part I: The housing market is definitely in speculative/overvalued territory, even after adjusting for zero property taxes: home ownership rates are already exceptionally high, while rental yields are as low as 1-1.5%, so most new property being purchased is literally speculative. Homes in Beijing and Shanghai are 2-3x overvalued compared to US cities and a price correction would likely involve 10-20 years of stagnant to declining home prices as wages grow high enough to meet existing prices. <br/>
                    <br/>Your mission, should you choose to accept it, is to find ways for Chinese consumers to use their low-return capital.  Right now, that means selling luxury goods and travel experiences, but whoever can give Chinese investors a 4% USD-denominated yield will become a very rich man.
                    <br/>
                    <br/><b> Total nonsequitur: </b> <br />
                    If you're a particularly eagle-eyed reader, you'll notice Dallas home prices-to-take-home pay is <u>incredibly low</u>: $200,000 for a 900-sq foot home looks like a steal, and to add on top of that zero state taxes and my initial reaction to this was to start looking for a job in Dallas (just kidding: Dallas sucks).  Here's the issue:  Dallas property taxes are insanely high: at 3.6%, owning a $100,000 home would be like having a $100,000 loan that charges you $300 a month in taxes.  Property values appear to be depressed as a result:  <b>Dallas collects only 10% more tax revenue per property than Brooklyn despite having 4x higher property tax rates.</b><br/>
                    ...
                    The Laffer Curve exists!  Make sure Rand Paul doesn't find out about the Dallas home market or you will never hear the end of it.
                </div>)
    }
}
