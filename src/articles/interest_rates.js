...
class InterestRates extends React.Component {
    ...
    render() {
        return (<div className="article-wrapper">
            ...
            As interest rates declined, low-multiple-investors (aka "value investors") have floundered because they fail to a). correctly capitalize the costs of software development as an asset, not an expense, b). overvalue near-term earnings because of their overly high cost-of-capital requirements.
            The flip, sadly, is that people like WeWork founder Adam Neumann become the dominant model of outsized wealth creation.
            <br/><br/>2). Monopolies will be more valuable than ever. As required returns lower, capital will flow toward non-monopolistic, competitive industries (think Quip, Boll & Branch, and whatever other favorite podcast sponsor you have) and reduce returns in those industries even further than where they are now. 
            ...
            <br/><br/> Why do low future rates bring about Neofeudalism?  Interest rates are like a very long lever.  As rates go lower, the lever gets longer, and the more valuable income streams become.  At some point the lever itself becomes a sort of king-maker:  if you are able to build a perpetual-income business of any kind, you will effectively control an economic fiefdom, because that income stream will be considered incredibly valuable.  And if you fail to create that perpetual income stream, you'll be a serf, forced to either deplete your store, never able to earn enough from the capital that's been saved.
