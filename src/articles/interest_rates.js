...
class InterestRates extends React.Component {
    ...
    render() {
        return (<div className="article-wrapper">
            ...
            What he discovered surprised me: nominal and real rates over very long periods of time are in "suprasecular decline" and that the fall in real and nominal interest rates over the last forty years are merely a reversion to long-term historical trends. When I say "interest rates", I mean both literal rates (paid for debt servicing), as well as effective rates (i.e., at what earnings multiple stocks trade).  Schmelzing is more limited in his definition but I will use the term "falling rates" to mean both lowering bond yields and rising equity multiples.<br/>
