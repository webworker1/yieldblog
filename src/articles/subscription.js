    ...
    render() {
        return (
            <div className="article-wrapper">
                ...
                3). Access to articles <u> before </u> deals are closed (being fast is just as important as being right), and access to my e-mail blast whenever I spot a promising idea. <br/>
                4). Ability to make suggestions on future ideas that I research:  I'm mostly writing this blog because I have to find new investments every couple months to allocate my household income, and your ideas to diligence are greatly appreciated.<br/>
                If you consider the fact that the typical fund manager chargers 0.5% - 1% of managed assets, $5 a month is stupidly cheap enough that you should consider it to be a nominal figure that is designed mostly to retain serious community members. <br/>
