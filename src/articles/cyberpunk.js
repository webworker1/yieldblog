...
class Cyberpunk extends React.Component {
    ...
    render() {
        return (<div className="article-wrapper">
                    ...
                    CD Projekt Red's newest series, <Link href="https://amzn.to/36sBU7j">Cyberpunk 2077</Link> continues their tradition of finding barely-known source material stepped in a pre-existing genre and building
