...
class Cyberpunk extends React.Component {
    ...
    render() {
        return (<div className="article-wrapper">
                    ...
                    CD Projekt Red's newest series, <Link href="https://amzn.to/36sBU7j">Cyberpunk 2077</Link> continues their tradition of finding barely-known source material steeped in a pre-existing genre and building
                    a much more famous game from its foundation -- in this case drawing on a little-known tabletop RPG, <Link href="https://talsorianstore.com/collections/cyberpunk/products/cyberpunk-2020">Cyberpunk</Link>, and more generally drawing on a universe first envisioned by the extraordinary William Gibson
                    ...
                    Before we go any farther, if you don't know what Cyberpunk 2077 is, watch this gameplay trailer.  After you've had your fill (or, if you're like me, picked your jaw off the floor and changed your underwear), keep reading.
                    ...
                    CD Projekt Red, unlike other companies that have products that yield recurring revenue, must work their ass off for every dollar.  For CD Projekt Red's stock to be a slam-dunk buy, Cyberpunk 2077 will need to become the next GTA V, <u>twice</u>:
